...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { description: @movement.description, price: @movement.price, type: @movement.type } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { description: @movement.description, price: @movement.price, type: @movement.type } }
